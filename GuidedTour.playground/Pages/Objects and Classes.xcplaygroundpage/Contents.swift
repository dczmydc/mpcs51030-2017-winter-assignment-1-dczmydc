...
class Shape {
    ...
    func perimeter(avgLen: Int) -> Int{
        return (avgLen * numberOfSides)
    }
}

var s = Shape()
print(s.perimeter(avgLen:7))
//: - Experiment:
...
//my code for class circle from here
class Circle:NamedShape{
    ...
    override func simpleDescription() -> String {
        return "A circle called \(name) with radius \(radius)"
    }
}

var c1 = Circle(radius: 2.0, name: "wheel")
print(c1.area())
